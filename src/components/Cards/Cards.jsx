  ...
  return (
    <div className="card bg-[#A9BCD0] w-[21rem] h-[22rem] p-7 text-black flex flex-col gap-2 justify-end mb-4 shadow-cardshadow transition-transform duration-500">
      ...
      <div className=" flex justify-between items-center">
        ...
        {stock > 0 && (
          <button className="w-[110px] bg-black h-[40px] my-3 flex items-center justify-center rounded-xl cursor-pointer relative overflow-hidden transition-all duration-500 ease-in-out shadow-md hover:scale-105 hover:shadow-lg before:absolute before:top-0 before:-left-full before:w-full before:h-full before:bg-gradient-to-r before:from-[#070b0c] before:to-[#58A4B0] before:transition-all before:duration-500 before:ease-in-out before:z-[-1] before:rounded-xl hover:before:left-0 font-[garuteRegular] text-[#fff]">
            Buy
          </button>
        )}
      </div>
